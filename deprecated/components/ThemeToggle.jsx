...
const SVG = {
  ...
  dark: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
};
...
export default function ThemeToggle() {
  ...
  const { t } = useI18n();
  return (
    <button type="button" className="theme-toggle topbar-icon-btn" onClick={cycle} title={t(`theme.${theme}`)}>
      <span aria-hidden="true" style={{display: 'flex', alignItems: 'center'}}>{SVG[theme]}</span>
